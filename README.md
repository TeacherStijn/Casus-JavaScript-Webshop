...
- Het MAIN element bevat een met JavaScript gegenereerde verzameling aan producten die besteld kunnen worden.

  BONUS voor als je klaar met: maak ook achter de schermen een voorraad die aangepast kan worden door te bestellen. Maak deze productlijst middels een Map Object met het product en de bijbehorende voorraad. 
...
BONUS (indien je tijd over hebt):
